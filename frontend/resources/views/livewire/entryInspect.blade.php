...
<div>
    ...
    <div id="entryContent">
        ...
        <div class="card-header">
            <h3 class="card-title">INFO DE CATEGORIA</h3>
        </div>
            ...
            <table class="styled-table">
                ...
                <tr>
                    <td><span class="badge badge-primary"> {{ $entry['categories']['id'] }}</span></td>
                    <td><span class="badge badge-primary"> {{ $entry['categories']['name'] }}</span></td>
                    <td><span class="badge badge-primary"> {{ $entry['categories']['description'] }}</span></td>
                </tr>
            </tbody>
        </table>
