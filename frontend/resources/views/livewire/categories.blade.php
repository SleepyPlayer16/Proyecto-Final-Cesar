...
<div>
    ...
    #crear {
        ...
        <ul>
            ...
            <li><a class="active" href="/categories">Categorías</a></li>
        </ul>
        ...
        <div class="card-body">
                ...
                <tbody>
                    @foreach ($categories as $category)
                        <tr>
                            ...
                            <td>
                                <a href="categories/{{$category['id']}}/edit" class="myButton"><i class="fa fa-save"></i> Modificar </a>
                                <a wire:click="borrar({{$category['id']}})" class="myButton"><i class="fa fa-save"></i> Eliminar </a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
            ...
            <?php else: ?>
                <p id="crear" >No hay categorías registradas.</p>
            <?php endif; ?>
        </div>
        <div style="padding:20px;"id="crear">
            <a href="/categories/create"class="myButton"><i class="fa fa-save"></i> Crear nueva categoría</a>
        </div>
