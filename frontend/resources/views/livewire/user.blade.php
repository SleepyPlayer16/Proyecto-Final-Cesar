...
<div>
    ...
    #crear {
        ...
        <ul>
            <li><a class="active" href="/user">Usuarios</a></li>
        ...
        <div class="card-body">
                ...
                <tbody>
                    @foreach ($users as $user)
                        <tr>
                            ...
                            <td>{{$user['role']}}</td>
                            <td>
                                <a href="user/{{$user['id']}}/inspect" class="myButton"><i class="fa fa-save"></i> Ver usuario</a>
                                <a href="user/{{$user['id']}}/edit" class="myButton"><i class="fa fa-save"></i> Modificar </a>
                                <a wire:click="borrar({{$user['id']}})" class="myButton"><i class="fa fa-save"></i> Eliminar </a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
            ...
            <?php else: ?>
                <p id="crear" >No hay usuarios registrados</p>
            <?php endif; ?>
        </div>

    </div>
    <div id="crear">
        <a href="/user/create"class="myButton"><i class="fa fa-save"></i> Crear nuevo usuario</a>
    </div>
