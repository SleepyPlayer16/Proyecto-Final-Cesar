...
Route::get('/users/{id}',[UsersController::class,'obtenerUsuario']);
...
Route::get('/entries/{id}',[EntriesController::class,'obtenerEntry']);
...
Route::get('/categories/{id}',[CategoriesController::class,'obtenerCategoria']);
